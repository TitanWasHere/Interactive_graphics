...
export class Carpet extends THREE.Group {
    ...
    createMesh(){
        ...
        const carpetGeo = new THREE.BoxGeometry(this.width, 0.1, this.depth);
        const goldGeo = new THREE.BoxGeometry(this.width, 0.1, this.depth * (1 / 20));
